# SISRU Automação - Jantar (v39.1)

Automação para o **SISRU** voltada à reserva de **jantar**, com lógica específica para aceleração em horários de pico, tratamento de CAPTCHA e monitoramento do estado do script.
...
* **Refeição Alvo:** Jantar
* **Licença:** MIT
* **Execução:** `document-idle`
* **Compatibilidade:** Navegadores com suporte a Tampermonkey/GreaseMonkey
* **URLs de atualização e suporte:**

  * [Update](https://raw.githubusercontent.com/seu-usuario/repositorio/main/sisru-jantar.user.js)
  * [Download](https://raw.githubusercontent.com/seu-usuario/repositorio/main/sisru-jantar.user.js)
...
| `TIPO_REFEICAO_ALVO` | Define a refeição alvo ("Jantar")         |
...
* CAPTCHA: `["verify you are human", "verificar se é humano"]`
...
```js
if ((d === 1 || d === 2) && h === 17) { tipo: 'PICO', descricao: 'Pico especial (Seg/Ter 17h)' }
```

Outros picos (mesmo dia):

* 17h48-17h52 → Abertura 17h50
* 19h27-19h45 → Xepa 19h27
