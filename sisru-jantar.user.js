...
(function () {
    ...
    const Logic = {
        ...
        analisarEAgir: () => {
            ...
            if (bodyText.includes("sua posição na fila") || bodyText.includes("aquisição de refeições")) {
            ...
            // ================================================================
            if (document.querySelector(CONFIG.SELETORES.CLOUDFLARE_IFRAME) || bodyText.includes("realize a validação do captcha")) {
